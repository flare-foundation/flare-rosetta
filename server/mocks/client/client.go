...
func (_m *Client) GetContractInfo(_a0 common.Address, _a1 bool) (string, uint8, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetContractInfo")
	}
...
// Peers_v1_11 provides a mock function with given fields: _a0, _a1, _a2
func (_m *Client) Peers_v1_11(_a0 context.Context, _a1 []ids.NodeID, _a2 ...rpc.Option) ([]client.Peer_v1_11, error) {
	_va := make([]interface{}, len(_a2))
	for _i := range _a2 {
		_va[_i] = _a2[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for Peers_v1_11")
	}

	var r0 []client.Peer_v1_11
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []ids.NodeID, ...rpc.Option) ([]client.Peer_v1_11, error)); ok {
		return rf(_a0, _a1, _a2...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []ids.NodeID, ...rpc.Option) []client.Peer_v1_11); ok {
		r0 = rf(_a0, _a1, _a2...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]client.Peer_v1_11)
		}
	}
...
func (_m *Client) TxPoolContent(_a0 context.Context) (*client.TxPoolContent, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for TxPoolContent")
	}
